...
distributed to Cessna Dealers and to those who subscribe through the Owner Follow-Up System. If you
...
61.9
12.9
H22-A- 7 CESSNA 300 NAV/COM, 720 CH COM 1ST UNIT
...
H25-A- 1 CESSNA 300 NAV/COM, 720 CHANNEL 2ND UNIT
WITH VOR/LOC
RECEIVER-TRANSCEIVER (RT-328T)
VOR/LOC INDICATOR (IN-514B)
...
17.0
13.0
H25-A- 2 CESSNA 300 NAV/COM, 720 CH, SECOND UNIT
WITH VOR/ILS
RECEIVER-TRANSCEIVER (RT-385A)
VOR/LOC INDICATOR
H37-A ANTENNA & COUPLER KIT
...
17.0
13.3
H25-A- 3 CESSNA 300 NAV/COM 720 CH COM 2ND UNIT
RECEIVER-TRANSCEIVER (RT-385A)
...
17.0
13.3
H25-A- 4 CESSNA 300 NAV/COM 720 CH COM 2ND UNIT
RECEIVER-TRANSCEIVER (RT-328T)
VOR/LOC INDICATOR (IN-514B)
H37-A ANTENNA & COUPLER KIT
...
H22-A-1 CESSNA 300 NAV/COM RT-308C
H22-A- 2 CESSNA 300 NAV/COM RT-385A
...
H16-A-1 CESSNA 300 TRANSPONDER RT-359A
...
### CESSNA PROGRESSIVE CARE ..................................................................................................................... 5

### CESSNA CUSTOMER CARE PROGRAM ....................................................................................................... 6
...
and servicing of your Cessna. It also identifies certain inspection and maintenance requirements which
...
Keep in touch with your Cessna Dealer and take advantage of his knowledge and experience. He knows
...
Your Cessna Dealer has an Owner Follow-Up System to notify you when he receives information that
applies to your Cessna. In addition, if you wish, you may choose to receive similar notification, in the
form of Service Letters, directly from the Cessna Customer Services Department. A subscription form is
supplied in your Customer Care Program book for your use, should you choose to request this service.
Your Cessna Dealer will be glad to supply you with details concerning these follow-up programs, and
...
available from your Cessna Dealer.
...
o AVIONICS
```
Your Cessna Dealer has a Customer Care Supplies Catalog covering all available items, many of which he
...
Cessna recommends that these items, plus the Pilot’s Operating Handbook, Pilot’s Checklists, Power
...
Specific benefits and provisions of the CESSNA WARRANTY plus other important benefits for you are
...
airplane. While these important inspections will be performed for you by any Cessna Dealer, in most
...
proper procedures are followed. Your Cessna Dealer should be contacted for further information or for
...
Since Cessna Dealers conduct all service, inspection, and test procedures in accordance with applicable
Service Manuals, it is recommended that you contact your Cessna Dealer concerning these
requirements and begin scheduling your airplane for service at the recommended intervals.

Cessna Progressive Care ensures that these requirements are accomplished at the required intervals to
...
```
CESSNA 300 NAV/COM (COM/VOR, No LOC – Type RT-308C) ............................................................... 11
```
```
...
```
CESSNA 300 NAV/COM (720-Channel – Type RT-328T) ......................................................................... 15
...
```
CESSNA 300 NAV/COM (720-Channel – Type RT-385A) ......................................................................... 19
...
```
CESSNA 300 TRANSPONDER (Type RT-359A) AND OPTIONAL ENCODING ALTIMETER (Type EA-401A) 29
...
```
CESSNA 300 TRANSPONDER (Type RT-359A) AND OPTIONAL ALTITUDE ENCODER (BLIND) ................. 33
```
```
...
```
CESSNA 400 TRANSPONDER (Type RT-459A) AND OPTIONAL ENCODING ALTIMETER (Type EA-401A) 37
```
```
...
```
CESSNA 400 TRANSPONDER (Type RT-459A) AND OPTIONAL ALTITUDE ENCODER (BLIND) ................. 41
...
```
CESSNA 400 MARKER BEACON (Type R-402A) ....................................................................................... 45
```
```
...
```
CESSNA 400 GLIDE SLOPE (Type R-443B) ................................................................................................ 49
...
```
Figure 1. Cessna 300 Nav/Com (Type RT-308C) – VOR only
```
...
```
Figure 1. Cessna 300 Nav/Com (Type RT-328T)
```
### 1. RECEIVER-TRANSMITTER FREQUENCY INDICATOR.
...
```
Figure 1. Cessna 300 ADF Operating Controls and Indicators
```
...
CESSNA 300 TRANSPONDER (Type RT-359A) AND OPTIONAL ENCODING ALTIMETER (Type

EA-401A)

SECTION 1 – GENERAL

The Cessna 300 Transponder (Type RT-359A), shown in Figure 1, is the airborne component of an Air
...
The Cessna 300 Transponder consists of a panel-mounted unit and an externally-mounted antenna. The
...
All Cessna 300 Transponder operating controls, with the exception of the optional altitude encoder’s
...
```
Figure 1. Cessna 300 Transponder and Encoding Altimeter
```
...
The Cessna 300 Transponder system consists of a panel-mounted unit and an externally-mounted
...
All Cessna 300 Transponder operating controls are located on the front panel of the unit. Functions of
...
```
Figure 1. Cessna 400 Transponder and Encoding Altimeter Operating Controls
```
1. FUNCTION SWITCH – Controls application of power and selects transponder operating mode as
    follows:
       OFF – Turns set off.
...
```
Figure 1. Cessna 400 Marker Beacon Operating Controls and Indicator Lights
```
...
The Cessna 400 Glide Slope is an airborne navigation receiver which receives and intercepts glide slope
...
The Cessna 400 Glide Slope system consists of a remote-mounted receiver coupled to an existing
...
Operation of the Cessna 400 Glide Slope system is controlled by the associated navigation system. The
functions and indications of typical 300 series glide slope indicators are pictured and described in Figure

1. The 300 series glide slope indicator shown in Figure 1 depict typical indications for all Cessna-crafted
